...
import './admin/screens/ongoing_page.dart';
import './admin/widgets/sub_page.dart';
import './students/screens/setting_payment.dart';
import './students/screens/ongoing_coupons.dart';
import './admin/screens/total_earnings.dart';
import './admin/screens/oreder_received.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider.value(value: Coupons()),
      ],
      child: MaterialApp(
        ...
        routes: {
          ...
          OngoingScreen.routeName: (ctx) => OngoingScreen(),
          SettingsPay.routeName: (ctx) => SettingsPay(),
          OngoingCoupons.routeName: (ctx) => OngoingCoupons(),
          Balance.routeName: (ctx)=> Balance(),
          OrderReceived.routeName: (ctx)=> OrderReceived(),
